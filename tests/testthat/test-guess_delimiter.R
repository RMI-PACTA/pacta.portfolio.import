...
test_that("returns appropriate value when last field is blank", {
  last_field_blank <- withr::local_tempfile()
  writeLines("1,2,3\n1,2,", last_field_blank)
  expect_identical(guess_delimiter(last_field_blank), ",")
})

test_that("returns appropriate value when last field is quoted", {
  last_field_quoted <- withr::local_tempfile()
  writeLines('1,2,3\n1,2,"3 "', last_field_quoted)
  expect_identical(guess_delimiter(last_field_quoted), ",")
})
